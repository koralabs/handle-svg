...
cd "$ROOT_DIR"
node --test --experimental-test-coverage tests/*.test.cjs > "$TMP_OUTPUT" 2>&1
...

{
    ...
    echo "STATUS=$STATUS"
    echo "SOURCE_PATHS=lib/utils/checkContrast.js,lib/utils/constants.js,lib/utils/getMaxOffset.js,lib/utils/imageHelpers.js"
